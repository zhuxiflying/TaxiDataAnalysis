...
/** 
 * The ProjectionTransformation class implements an coordinates projection by Proj4j.
 * Specifically, the example below demonstrate the projection from WGS84 to UTM18N.
 * The New York Taxi Trip data (yellow cab trips from 2009 to 2015) adopted in this example.
 */
public class ProjectionTransformation {
	...
	public static void main(String[] args) throws Exception
	{
	     ...
	     * 
	     * double[] coordinates = {-73.995917,40.728576};
	     *  p1.x = coordinates[0];
	     *  p1.y = coordinates[1];
...
//				System.out.println(filename);
				String filename2 = "D:\\Data\\NY_Taxi_tripdata2\\yellow_tripdata_"+year+"-"+month+".csv";
